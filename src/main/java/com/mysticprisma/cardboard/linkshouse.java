 ...
 */
package com.mysticprisma.cardboard;
...
import com.mysticprisma.cardboard.R;
...
public class linkshouse extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
  static {
    System.loadLibrary("cardboard_jni");
  }
  MediaPlayer mp;

  private static final String TAG = linkshouse.class.getSimpleName();
